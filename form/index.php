    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="date" id="fechaGasto" class="form-control" value="<?php echo date('Y-m-d'); ?>">
                <small class="text-muted">Si no seleccionas fecha, se usará la actual</small>
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <div class="input-container">
                    ...
                    <i id="borrarTextoMontoGasto" class="fas fa-times text-danger"
                        onclick="eliminaTexto('monto_gasto',this)"></i>
                </div>
            </div>
        </div>
    </div>
    <div class="input-container">
        <input class="w-100 form-control mb-3" type="text" id="tipoGasto" name="tipoGasto" placeholder="Tipo Gasto"
        ...
        if (!validacion) {
            ...
            $.post("./form/conexiones.php", {
                ...
                if (response.success) {
                    ...
                    document.getElementById("fechaGasto").value = ""; // Limpiar fecha
